...
class BasePolicy:
    ...
    def _init_sdk_components(self):
        ...
        if self.sdk_type == "unitree":
            ...
            if self.config.get("INTERFACE", None):
              print("INTERFACE: ", self.config["INTERFACE"])
              print("DOMAIN_ID: ", self.config["DOMAIN_ID"])
    ...
    def process_joystick_input(self):
        ...
        # # Debug: print current velocity and stand state whenever joystick input is processed
        # try:
        #     self._print_control_status()
        # except AttributeError:
        #     # Some policies may not override _print_control_status; ignore in that case
        #     pass
